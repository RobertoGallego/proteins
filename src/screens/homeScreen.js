...
const HomeScreen = ({ navigation, colorsLight, setColorsLight, setJmolRasmol, jmolRasmol, setTranslateApp, translateApp  }) => {
  ...
  return (
    <View style={styles.container}>
      {/* <ScrollView keyboardShouldPersistTaps="true"> */}
        <View style={styles.searchBarContainer}>
          ...
          <TextInput
            ...
            value={search}
            placeholder={!translateApp ? "Barra de busqueda" : "Protein search"}
      ...
      />
      <HomeFooter colorsLight={colorsLight} jmolRasmol={jmolRasmol} setColorsLight={setColorsLight} setTranslateApp={setTranslateApp} setJmolRasmol={setJmolRasmol} translateApp={translateApp}/>
